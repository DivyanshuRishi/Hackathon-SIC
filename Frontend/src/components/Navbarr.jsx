...
function Navbarr() {
  ...
  useEffect(() => {
    // Fetch role from localStorage or any state management library
  ...
  const handleProfileClick = () => {
    if (!role) {
      ...
      // If already logged in, navigate to profile or any other page based on role
      navigate('/profile'); // You can create a profile page for displaying user/admin info
    }
  };
        ...
        <div className="navbar bg-base-100">
          ...
          <div className="flex-none gap-2">
            <div className="form-control">
              <input type="text" placeholder="Search" className="px-3 py-2 border rounded-md w-24 md:w-auto" />
            </div>
                  ...
                  <>
                    <li>
                      <a onClick={handleProfileClick} className="justify-between">
                        Profile ({role === 'admin' ? 'Admin' : 'User'}) {/* Display role */}
                      </a>
                    </li>
                    <li><a>Settings</a></li>
